...
interface TMDBNowPlayingApiService {
    ...
    companion object {
        operator fun invoke(connectivityInterceptor: ConnectivityInterceptor) : TMDBNowPlayingApiService {
            ...
            return Retrofit.Builder()
                ...
                .build()
                .create(TMDBNowPlayingApiService::class.java)
        }
    }
}